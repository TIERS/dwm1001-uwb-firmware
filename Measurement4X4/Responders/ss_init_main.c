...
*           This code is designed to be flashed into the devices initially configured as responders. 
* 
*
* @author Carmen Martinez Almansa
*/
#include <stdio.h>
#include <string.h>
#include <math.h>
...
/*Device ID*/
int my_id = 2; //CHANGE THIS TO THE DESIRED ID BEFORE PROGRAMMING THE DEVICE (1-Device starting as INITIATOR, 2,3,4 Responders)
...
int ss_init_run(void)
{
  ...
  else
  {
   ...
   // printf("MEAN = %f \r\n", mean);
    //printf("MEAN most significant byte = %d\r\n", mean_msb);
    //printf("MEAN least significant byte = %d\r\n", mean_lsb);
    ...
    //printf("SD most significant byte = %d\r\n", SD_msb);
    //printf("SD least significant byte = %d\r\n", SD_lsb);
